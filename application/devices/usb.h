...
extern "C" {
  ...
  /* <arch>.c */
  extern int (*usb_bulk_write)(usb_dev_handle *dev, int ep, char *bytes, int size,
                     int timeout);
  extern int (*usb_bulk_read)(usb_dev_handle *dev, int ep, char *bytes, int size,
                    int timeout);
  extern int (*usb_interrupt_write)(usb_dev_handle *dev, int ep, char *bytes, int size,
                          int timeout);
  extern int (*usb_interrupt_read)(usb_dev_handle *dev, int ep, char *bytes, int size,
                         int timeout);
  extern int (*usb_control_msg)(usb_dev_handle *dev, int requesttype, int request,
