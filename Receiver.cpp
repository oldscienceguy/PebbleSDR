...
#include "gpl.h"
//#include "build.h" //Generated by SubVersion
#include "Receiver.h"
...
Receiver::Receiver(ReceiverWidget *rw, QMainWindow *main)
{
	...
	welcome <<
		...
		"Pebble SDR build " + QString(BUILD_NUMBER) + " - " + QString(BUILD_DATE) <<
		"Copyright 2010 Richard Landsman N1DDY (pebblesdr@gmail.com)" <<
