...
#define MIR_SDR_API_VERSION   (float)(1.80)
...
extern "C"
{
   ...
   _MIR_SDR_QUALIFIER mir_sdr_ErrT mir_sdr_SetParam(unsigned int id, unsigned int value);   // This MUST be called before mir_sdr_Init()
